...
namespace DDTLibrary {
	...
	template <class treeType> class ListAsATreeExtension;

	template <class treeNode> class ListAsATreeNodeExtension;

	//Tree Node Adapters
	///////////////////////////////////////////////////////////////
	template <class treeNode>
	class ListAsATreeNodeExtension : public treeNode {
	public:
		////////////////////////////////////////////////////////////////////////
		...
		typedef typename treeNode::objectTraits::template transform<ListAsATreeNodeExtension*>::value_type element_pointer_unlogged;
		typedef typename treeNode::objectTraits::template transform<ListAsATreeNodeExtension&>::value_type element_reference_unlogged;

		typedef typename treeNode::ddtTraits::template transform<ListAsATreeNodeExtension*>::value_type element_pointer;
		typedef typename treeNode::ddtTraits::template transform<ListAsATreeNodeExtension&>::value_type element_reference;
		...
		ListAsATreeNodeExtension (const_input_reference data, element_pointer_unlogged sentinel, element_pointer_unlogged parent) {
	...
	class ListAsATreeExtension : public treeType {
	public:
		////////////////////////////////////////////////////////////////////////
